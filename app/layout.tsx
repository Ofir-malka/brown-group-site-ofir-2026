...
title: {
default: "דירות למכירה ולהשכרה בתל אביב | Brown Group",
...
publisher: "בראון גרופ",
  ...
  description:
  "מחפשים דירה בתל אביב? Brown Group מציעה דירות יוקרה, פנטהאוזים ונכסים למכירה ולהשכרה באזורים המבוקשים בעיר, עם ליווי אישי ומקצועי.",
  keywords: [
"בראון גרופ",
"בראון גרופ נדלן",
"בראון גרופ נדל״ן",
...
verification: {
  ...
  openGraph: {
    ...
    siteName: "בראון גרופ",
    title: "דירות למכירה ולהשכרה בתל אביב | Brown Group",
description:
  "מחפשים דירה בתל אביב? Brown Group מציעה דירות יוקרה, פנטהאוזים ונכסים למכירה ולהשכרה באזורים המבוקשים בעיר, עם ליווי אישי ומקצועי.",
    images: [
      {
